...
public class PipeEditor : MonoBehaviour
{
    ...
    public Button[] brushButtons;   // 0=Start 1=End 2=Straight 3=Bend 4=Tee 5=Cross 6=Start2 7=Erase
    ...
    public enum Brush { Start, End, Straight, Bend, Tee, Cross, Start2, Erase }
